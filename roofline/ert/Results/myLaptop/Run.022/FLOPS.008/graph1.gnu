...
set nox2tics
set noy2tics
set title "Graph 1 (Results/myLaptop/Run.022/FLOPS.008)"
...
set output "Results/myLaptop/Run.022/FLOPS.008/graph1.ps"
plot "Results/myLaptop/Run.022/FLOPS.008/pre" using 2:4
#EOF
