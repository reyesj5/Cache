...
set nox2tics
set noy2tics
set title "Graph 1 (Results/myLaptop/Run.022/FLOPS.016)"
...
set output "Results/myLaptop/Run.022/FLOPS.016/graph1.ps"
plot "Results/myLaptop/Run.022/FLOPS.016/pre" using 2:4
#EOF
